      ...
      <form className="form" onSubmit={(e) => this.handleSubmit(e, data)} >
        ...
        <div className="row">
          ...
          <div className="col-75">
            {this.props.edit ?
              (<input type="text" id="fname" name="name" value={data.name} onChange={this.handleChange} placeholder="Project name..." />) : (
        ...
        <div className="row">
          ...
          <div className="col-75">
            {this.props.edit ?
              (<input type="date" id="startDate" value={data.startDate} onChange={this.handleChange} name="startDate" />) : (
        ...
        <div className="row">
          ...
          <div className="col-75">
            {this.props.edit ?
              (<input type="date" id="endDate" value={data.endDate} onChange={this.handleChange} name="endDate" />) : (
        ...
        <div className="row">
          ...
          <div className="col-75">
            {this.props.edit ?
              (
                <select name="status" id="status" value={data.status} onChange={this.handleChange}>
                  <option value=""></option>
